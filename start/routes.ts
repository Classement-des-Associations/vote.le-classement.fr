...
Route.group(() => {
  ...
  Route.get('votes/charts/:year/top-associations', 'ChartsController.topAssociations')
  Route.get('votes/charts/:year/top-associations-by-day', 'ChartsController.topAssociationsByDay')
