...
export default class AssociationUpdateValidator {
  ...
  public schema = schema.create({
    ...
    facebook: schema.string.optional([rules.trim(), rules.maxLength(255), rules.escape()]),
    twitter: schema.string.optional([rules.trim(), rules.maxLength(255), rules.escape()]),
    instagram: schema.string.optional([rules.trim(), rules.maxLength(255), rules.escape()]),
    linkedin: schema.string.optional([rules.trim(), rules.maxLength(255), rules.escape()]),
    website: schema.string.optional([rules.trim(), rules.maxLength(255), rules.escape()]),
